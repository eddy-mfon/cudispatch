    ...
    return (
        <footer className="bg-[#1A1A1A] text-white pt-16 pb-12 px-4 sm:px-6 lg:px-8 font-sans">
            <div className="max-w-7xl mx-auto border border-white/10">
                ...
                {/* Top Section */}
                <div className="grid grid-cols-1 lg:grid-cols-5 border-b border-white/10">

                    {/* Left Box (Hero Text + Avatars) */}
                    <div className="lg:col-span-2 p-8 md:p-12 border-b lg:border-b-0 lg:border-r border-white/10 flex flex-col justify-between min-h-[300px]">
