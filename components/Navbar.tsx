        ...
        <div className="flex justify-between items-center h-12">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-4 ml-4">
                {isLoggedIn ? (
                    <>
                        <div className="flex items-center space-x-2 px-3 py-1.5 bg-gray-100 rounded-full border border-gray-200 hover:bg-white hover:border-gray-300 transition-all cursor-default shadow-sm">
                    ...
                    <>
                        ...
                        <button onClick={onSignupClick} className="bg-black text-white px-5 py-2.5 rounded-none text-sm font-bold hover:bg-gray-800 transition-all hover:shadow-lg hover:-translate-y-0.5 cursor-pointer border border-black active:scale-95">
                            Sign Up
                        </button>
                    </>
                )}
