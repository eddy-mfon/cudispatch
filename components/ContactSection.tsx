...
const ContactSection: React.FC<ContactSectionProps> = ({ onBack }) => {
    ...
    return (
        <div className="min-h-screen w-full flex bg-white font-sans">
                ...
                <div className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8">
                        ...
                        <button
                            type="submit"
                            disabled={status === ContactStatus.SUBMITTING}
                            className="w-full bg-[#1A1A1A] text-white font-extrabold tracking-tight py-4 mt-4 hover:bg-black transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed rounded text-sm flex items-center justify-center"
                        >
            ...
            {/* Right Side - Black Pane with Blue Gradient */}
            <div className="hidden md:flex w-1/2 bg-gradient-to-br from-[#050505] via-[#0a0a0a] to-[#001f3f] p-12 lg:p-20 flex-col justify-center relative overflow-hidden">
                {/* Icon Top Right */}
                <div className="absolute top-12 right-12">
                    <div className="relative transform hover:scale-110 transition-transform duration-300">
                        <div className="absolute inset-0 bg-blue-500/20 blur-xl rounded-full"></div>
                        <Phone className="w-20 h-20 text-white relative z-10" strokeWidth={1.5} />
                        <div className="absolute -top-3 -right-3 w-8 h-8 border-t-4 border-r-4 border-blue-400 rounded-tr-xl"></div>
